<template>
    <div class="footer center">
        <div class="footer__company">
            ...
            <p class="footer__company_text">It's a long established fact that
                a reader will be distracted lookings.</p>
            <nav class="footer__company_socials">
                <a href="#" class="footer__company_socials-twit">
        ...
        <nav class="footer__pages">
            ...
            <router-link to="/" class="footer__menu_link">Home</router-link>
            <router-link to="/project" class="footer__menu_link">Project</router-link>
            <router-link to="/blog" class="footer__menu_link">Blog</router-link>
            <router-link to="/blogDetails" class="footer__menu_link">Blog Details</router-link>
        </nav>
        <div class="footer__contacts">
            <p class="footer__heading">Contact</p>
            <p class="footer__contacts">55 East Brichwood Ave. Brooklyn, New York 11201</p>
            <p class="footer__contacts">contact@interno.com</p>
            <p class="footer__contacts">(123) 456 - 7890</p>
        </div>
    </div>
</template>
